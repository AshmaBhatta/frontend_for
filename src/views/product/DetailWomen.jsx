...
class ProductDetailViewWomen extends Component {
  constructor(props) {
    super();
    this.state = {};
  }
          ...
          <div className="col-md-8">
            <div className="row mb-3">
              <div className="col-md-5 text-center">
                <img
                  src=".../../images/products/women1.jpg"
                  className="img-fluid mb-3"
                  alt=""
                />
                <img
                  src="../../images/products/women1.webp"
                  className="border border-secondary mr-2" width="75"
                  alt="..."
                />
                <img
                  src="../../images/products/women2.jpg"
                  className="border border-secondary mr-2" width="75"
                  alt="..."
                />
                <img
                  src="../../images/products/women3.dpg"
                  className="border border-secondary mr-2" width="75"
                  alt="..."
                />
              </div>
...
export default ProductDetailViewWomen;
